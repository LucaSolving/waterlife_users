        ...
        <div id="carrito" class="col-md-4 col-12 text-center info-socio">
            ...
            <div class="row">
                <div class="col-md-12 col-12">
		            <!--form action="/shop_transferencia" id="form_payment_cart" method="POST"-->
		            <form action="/shop_tarjeta" id="form_payment_cart" method="POST">
...
$(document).ready(function () {
    ...
    $("#payment_cart_admin").click(function(e){
        ...
        if(checked_cliente == 0)
        {
            ...
            //document.form_payment_cart.action = "/shop_admin_approve";
        ...
        if (Culqi.token) {  // ¡Objeto Token creado exitosamente!
            ...
            $.ajax({
                ...
                success: function (codigo_cip) {
                    ...
                    //window.location.href = "/shop_pago_efectivo/"+codigo_cip;
                },
                statusCode: {
                    404: function() {
                        alert('Web not found');
