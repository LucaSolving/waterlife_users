...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-2 col-5">
            <p class="fs-7"><strong>MIS COMPRAS</strong></p>
        </div>
        <div class="col-md-9 col-7">|&nbsp;&nbsp;&nbsp;<a href="/my_shopping_red" class="fs-7">Ver compras de mi red</a></div>
        ...
        <div class="col-md-12">
            ...
            <div class="row pb-3">
                ...
                <div class="col-md-2 col-12">
                    <input type="text" class="form-control" id="nro_pedido"  placeholder="Nro de Pedido">
                </div>
                <div class="col-md-3 col-12">
                    <div class="row">
                        <div class="col-md-6 col-12">
                    		<button type="button" class="btn btn-secondary filter-margin" onclick="filtrarPedido()" style="width: 100%">BUSCAR</button>
                    	</div>
                        <div class="col-md-6 col-12">
                    		<a type="button" href="https://lucasolving.com/onlinebak/excel-generator/my_shopping.php?id={{auth()->user()->id}}" class="btn btn-secondary info-socio" style="width: 100%">DESCARGAR</a>
                    	</div>
                    </div>
                </div>
            </div>
	...
	<div class="modal fade" id="modal_detail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	    <div class="modal-dialog">
	        <div class="modal-content">
                ...
                <p class="text-center">Pago: <b id="type_member_modal"></b></p>
	            ...
	            <div class="row mx-3 mb-2">
	                ...
	                <div class="col-md-6 text-danger" id="type_desc_modal"></div>
	            ...
	            <div class="row mx-3 mb-2">
	                <div class=col-md-8>Método de Pago:</div>
	                <div class="col-md-4 text-center" id="type_payment_modal"></div>
	            </div>
	            <hr class="mx-3">
	            <div class="row mx-3 mb-2">
...
<script>
            ...
            columns: [
                ...
                {"data" : "delivery_status"},
                {
                    ...
                    "mRender": function(data, type, value) {
                        return `<a href="#" class="link-primary" onclick="openModal(${value['id']},'${value['order_date']}',${value['cost_delivery']},${value['subtotal']},${value['total_amount']},${value['discount_applied']},${value['discount_amount']},${value['total']},${value['total_points']},'${value['address']}','${value['reference']}','${value['indication']}','${value['type_member']}','${value['payment_status']}')" ><i class="bi bi-eye-fill"></i></a>`;
                    }
                },
            ],
            "language": {
    ...
    function openModal(id, fecha, cost_delivery, subtotal, total_amount,discount_applied,discount_amount,total,total_points, address,reference,indication,type_member,payment_status)
    {
        ...
        $("#type_desc_modal").empty()        
        $("#type_member_modal").empty()
        $("#type_payment_modal").empty()        
        ...
        $.ajax({
            ...
            success: function (product) {
                ...
                if(type_member==1){ 
                    type_member = 'Socio';
                    type_desc = 'Descuento';
                    discount_amount = '-S/ '+discount_amount.toFixed(2);
                    ...
                    total_amount = 'S/ '+(subtotal+cost_delivery).toFixed(2);
                }

                if(payment_status=='Pagado'){ type_payment = 'Tarjeta'; }else{ type_payment = 'Pago Efectivo'; }                
                ...
                $("#total_amount_modal").append(total_amount)
                $("#discount_applied_modal").append(discount_applied+'%')
                $("#discount_amount_modal").append(discount_amount)
                $("#total_modal").append(total)
                ...
                $("#type_desc_modal").append(type_desc)
                $("#type_member_modal").append(type_member)
                $("#type_payment_modal").append(type_payment)
    ...
    {
        let nro_pedido = document.getElementById('nro_pedido').value;

        if (nro_pedido) {
            orderFilter = myOrders.filter(item => {
                return item.id.toString().includes(nro_pedido.toString());
            })
        }
