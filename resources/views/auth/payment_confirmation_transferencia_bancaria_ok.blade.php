...
<div class="container mt-5">
    <div class="row">
        <div class="col">
            ...
            <p>Tu información de pago ha sido registrada.<br>
            En breve estaremos verificando la transacción y tu acceso a la plataforma Waterlife quedará habilitada.<br><br>
            Te enviaremos un correo electrónico con la confirmación.</p>
